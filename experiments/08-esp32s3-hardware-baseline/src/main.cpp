...
// ============================================================
// Sentinel Experiment 08
// LILYGO T-Display S3 Hardware Baseline
//
// Purpose:
//   Establish a continuity-scanner baseline on the intended
//   production processor/board while preserving the proven
//   Arduino GPIO measurement method.
//
// Changed variables relative to Experiment 07:
//   - TTGO T-Display / ESP32 -> LILYGO T-Display S3 / ESP32-S3
//   - GPIO assignment
//   - Short-delay characterization points
//
// Controlled variables:
//   - Full canonical 21-pair scan
//   - Active-low measurement
//   - External pull-ups
//   - 3.9 kOhm intended pull-up value
...
//   INPUT_PULLUP. External resistors provide the pull-ups.
//
// Important:
//   The firmware cannot verify the physical resistor value.
//   Verify 3.9 kOhm pull-ups in the test hardware.
// ============================================================
...
void setup()
{
    ...
    Serial.println();
    Serial.println("Sentinel Experiment 08");
    Serial.println("LILYGO T-Display S3 hardware baseline");
    Serial.println();
    ...
    Serial.println();
    Serial.println("GPIO idle mode: INPUT");
