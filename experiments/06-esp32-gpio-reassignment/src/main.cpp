...
// ============================================================
// Sentinel Experiment 06
// ESP32 GPIO Reassignment Characterization
//
// Purpose:
//   Determine whether the structured continuity errors observed
//   in Experiments 03 and 04 depend on the order in which the
//   seven logical lines are scanned.
//
// Controlled variables:
//   - Same TTGO T-Display V1.1 GPIO mapping
